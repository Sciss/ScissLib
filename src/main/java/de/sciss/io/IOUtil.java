...
public class IOUtil
{
     ...
     *  to shorten the path names attached to
...
//	}
     ...
     *	the method will first check if file <code>&quot;/Users/schoko/myFile.aif&quot;</code>
     *	exists, if not that file will be returned. Next, it will check for the file
     *	<code>&quot;/Users/schoko/myFile 1.aif&quot;</code>, then for
     *	<code>&quot;/Users/schoko/myFile 2.aif&quot;</code>
     *	etc.
     *
     ...
     *						of the file-type suffix will be used (and if not found, the end of the template).
